...
export default function Error({
  ...
  return (
    <main className="min-h-screen dark:bg-[#171717] flex items-center justify-center p-4">
      <article className="max-w-5xl w-full bg-white dark:bg-[#171717] rounded-2xl shadow-xl overflow-hidden">
        <div className="p-8">
